...
The site should feel like a modern privacy and cyber-compliance practice: calm, sharp, senior, and operational. It should not feel like an old legal brochure or a generic cybersecurity landing page.

## Design Principles

- Lead with clarity over drama.
- Use short sections and strong scan paths.
- Keep CTAs visible but not shouty.
- Make legal/compliance content feel manageable.
- Treat Hebrew RTL as the native layout, not an afterthought.
...
Use Hebrew-friendly sans-serif typography with generous line height. Reserve large display type for the hero and major sections. Body copy should stay readable and avoid long centered blocks.
